        ...
        <section class="cf dib br3 tc bw5 w-30 h-20 ma2 shadow-5 pa2-ns">
            <>
                <article class="fl w-100 w-50-m  w-25-ns pa2-ns">
                    ...
                    <h2 className="f3 tl">Original Price: <span
                        style={{color: "#820001", fontWeight: "bolder"}}>{deal.price.toFixed(2)}/-</span></h2>
                    <div class="ph2 ph0-ns pb3 pa1   db">
                        <p className="btn btn-danger tc white b pa-1 f4" style={{borderRadius: 40}}>Discounted
                            Price: {Math.abs(deal.discount).toFixed(2)}</p>
                        <br></br>
                        <button className="ant-btn ant-btn-primary"
                                style={{fontFamily: "'Open Sans Condensed', sans-serif", fontSize: 20, height: 50}}
                                onClick={updateCart}>Add to Cart
                        </button>
                    </div>
                </article>
            </>
